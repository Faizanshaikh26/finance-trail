    ...
    <div className="font-sans bg-white min-h-screen flex flex-col items-center py-10 sm:py-16 px-4 sm:px-6" id="contact"> 
      ...
      <div className="w-full max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 sm:gap-10">
          ...
          <div className="lg:col-span-2 bg-[#F0F6FF] rounded-2xl p-6 sm:p-8 space-y-6 sm:space-y-8">
            {/* Phone */}
            <div>
          ...
          <div className="lg:col-span-3 bg-white rounded-2xl p-6 sm:p-8 border border-gray-200 shadow-sm">
